...
regis:
    ...
    sleep_for(seconds(5));//  add delay for nanoseconds, system_clock, seconds
...
//faceauthentication:
  ...
  TRANSACTION:    
       transaction.initiateTransaction();// for transaction of money
      cout << "\nreturning to mainmenu................";
      sleep_for(seconds(5));
      system("cls");
      goto mainmenu;
  ...
  accmanage:
      ...
      switch (c)
      {
      case 1: acc_manage.confirm_emailchange();
          cout << "\nreturning to mainmenu................";
          sleep_for(seconds(1));
          system("cls");
          goto accmanage;
      case 2:acc_manage.confirm_passchange();
          cout << "\nreturning to mainmenu................";
          sleep_for(seconds(1));
          system("cls");
          goto accmanage;
      case 3: acc_manage.confirm_pinchange();
          cout << "\nreturning to mainmenu................";
          sleep_for(seconds(1));
          system("cls");
          goto accmanage;
